...
export {
  ...
  OLD_SCRATCH_CHAIN_LIGHTNING_DURATION,
  OLD_SCRATCH_CHAIN_LIGHTNING_WIDTH,
...
export { P2Attack, P3Attack } from './oldScratch'
export type { OldScratchState, CoffinNailZone, FireTrailSegment, SoulGeyserZone, ChainLightningState } from './oldScratch'
