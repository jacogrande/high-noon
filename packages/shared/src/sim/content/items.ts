...
const ITEMS: ItemDef[] = [
  ...
  },
  {
    ...
    description: 'On kill, fully heal.',
    rarity: 'cursed',
    trigger: 'onKill',
    stackFormula: 'unique',
    maxStack: 1,
    mods: [],
    hasEffect: true,
    downside: 'Lose 1 HP every 5 seconds.',
  },
  {
    id: 26,
    key: 'fools_errand',
    name: "Fool's Errand",
    description: 'Stash items upgraded one rarity tier.',
    rarity: 'cursed',
    trigger: 'passive',
    stackFormula: 'unique',
    maxStack: 1,
    mods: [],
    hasEffect: false,
    downside: 'Cannot buy from camp visitors.',
  },
  {
    id: 27,
    key: 'loaded_dice',
    name: 'Loaded Dice',
    description: 'All proc chances doubled.',
    rarity: 'cursed',
    trigger: 'passive',
    stackFormula: 'unique',
    maxStack: 1,
    mods: [],
    hasEffect: false,
    downside: 'All damage dealt reduced by 30%.',
  },
  {
    id: 28,
    key: 'unmarked_grave',
    name: 'Unmarked Grave',
    description: 'Stash rarity floor raised to silver.',
    rarity: 'cursed',
    trigger: 'passive',
    stackFormula: 'unique',
    maxStack: 1,
